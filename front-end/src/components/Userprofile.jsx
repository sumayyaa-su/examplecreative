...
//     if (!userName || !userEmail || !userBio || !userPassword || !userImage ) {
...
//         await axiosInstance.put(`http://localhost:5000/user/users/${selectedUser._id}`, userData);
//         alert('User updated successfully!');
//       } else {
//         // Create new user
//         await axiosInstance.post('http://localhost:5000/user/users', userData);
...
//     if (confirmDelete) {
//       try {
//         await axiosInstance.delete(`http://localhost:5000/user/users/${id}`);
...
const UserList = () => {
  ...
  return (
    <div className="d-flex" style={{ minHeight: '100vh' }}>
      {/* Error message */}
      {errorMessage && <div className="alert alert-danger" style={{ position: 'fixed', top: '10px', left: '50%', transform: 'translateX(-50%)', zIndex: 1000 }}>{errorMessage}</div>}
      ...
      {showForm && (
        <div style={{ width: '30%', padding: '20px', backgroundColor: '#f9f9f9', borderLeft: '1px solid #ddd', boxShadow: '0px 4px 6px rgba(0, 0, 0, 0.1)' }}>
          <h4>{selectedUser ? 'Edit User' : 'Create New User'}</h4>
          <Form>
            <Form.Group className="mb-3" controlId="userName">
              <Form.Label>Name</Form.Label>
